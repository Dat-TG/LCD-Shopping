...
class AddressBuyNowScreenArguments {
  final String totalAmount;
  final String productId;
  final int quantity;

  AddressBuyNowScreenArguments(this.totalAmount, this.productId, this.quantity);
}

class AddressBuyNowScreen extends StatefulWidget {
  static const String routeName = '/address-buynow';
  final String totalAmount;
  final String productId;
  final int quantity;
